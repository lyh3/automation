...
namespace DcPaeWebServiceUnitest
{
    ...
    {
        const string JSON_FILE = @"D:\Projects\DcPaeWebService\IntelDCGSpsWebService\App_Data\HelathEvent.json";
        const string sampleSystemResetJsonfileName = @"D:\Projects\DcPaeWebService\IntelDCGSpsWebService\App_Data\IpmiWarmReset.json";
        ...
        public void CommandMapTest()
        {
            ...
            var fileName = @"D:\Projects\DcPaeWebService\IntelDCGSpsWebService\App_Data\IpmiCommandList.json";
        ...
        {
            var path = @"d:\Projects\DcPaeWebService\IntelDCGSpsWebService\App_Data\Upload\";
